...
11. ✅ Validation des invariants C==U+Z, Cr==Ur
...
### TEST 4: Invariants C==U+Z, Cr==Ur
**Objectif:** Prouver que les invariants sacrés ne peuvent jamais être violés.

**Validations:**
- ✅ Genesis: C=0, U=0, Z=0, Cr=0, Ur=0 → invariants OK
- ✅ État normal: C==U+Z, Cr==Ur → invariants OK
- ✅ Violation détectée: C != U+Z → erreur retournée
...
- [x] Invariants C==U+Z, Cr==Ur garantis
