...
**Couverture**: Invariants C==U+Z/Cr==Ur, validation montants, persistance DB, hash déterministe, constantes consensus.
...
- ✅ Invariants formels C==U+Z/Cr==Ur déjà testés en Phase 1
