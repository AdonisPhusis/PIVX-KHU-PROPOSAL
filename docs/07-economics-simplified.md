...
"Vous perdez l'émission fixe (6→0 PIV/bloc)
 ...
 ✅ R% jusqu'à 30% (début) → 4% (minimum garanti)
...
**Q: L'inflation va exploser avec R% = 30%?**
A: Non. R% s'applique UNIQUEMENT aux ZKHU stakés, pas à la supply totale.
   Si 5% de la supply est stakée → inflation réelle = 1.5%.

**Q: La DAO va mourir après 6 ans?**
A: Non. Le Pool T accumule 0.5% × (U+Ur) tous les 4 mois.
...
A: R_MAX_dynamic = max(400, 3000 - year×100) en basis points.
   Après 26 ans, R_MAX = 4%. Les MN peuvent voter R% ≤ 4%.
