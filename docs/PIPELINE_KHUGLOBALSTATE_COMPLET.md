...
bool ConnectBlock(const CBlock& block, CBlockIndex* pindex, CCoinsViewCache& view)
{
    ...
    for (size_t i = 0; i < block.vtx.size(); i++) {
        ...
        // ───────────────────────────────────────────────────────
        // STAKE: KHU_T → ZKHU (pas de changement C/U)
        // ───────────────────────────────────────────────────────
        ...
        // ───────────────────────────────────────────────────────
            ...
            newState.U  += bonus;   // (1) Créer KHU_T pour bonus
            newState.C  += bonus;   // (2) Augmenter collateral
            newState.Cr -= bonus;   // (3) Consommer reward pool
            newState.Ur -= bonus;   // (4) Consommer reward rights

            LogPrintf("   │     Principal: %lld\n", principal);
            LogPrintf("   │     Bonus: %lld\n", bonus);
            LogPrintf("   │     U:  %lld → %lld (+%lld)\n", U_before, newState.U, bonus);
...
📦 PROCESSING 3 TRANSACTIONS
   ...
   │     U: 5000000000000 → 5100000000000 (+100000000000)
   └─ TX processed ✅
   ...
   │     Bonus: 5000000000
   │     U:  5100000000000 → 5105000000000 (+5000000000)
...
🔍 CHECKING INVARIANTS
✅ Invariants OK:
   C == U:   5105000000000 == 5105000000000 ✅
...
📊 FINAL STATE (height 152640):
   ...
   U  = 5105000000000 (Δ +105000000000)
...
- MINT: `C+=, U+=`
- REDEEM: `C-=, U-=`
- UNSTAKE: `C+=B, U+=B, Cr-=B, Ur-=B` (double flux)
- Yield: `Cr+=, Ur+=`
- DAO: `T+=`
...
```
Bloc 100000:  C=1000  U=1000  Cr=50   Ur=50   T=10   [MINT 500]
              ↓       ↓       ↓       ↓       ↓
Bloc 100001:  C=1500  U=1500  Cr=50   Ur=50   T=10   [STAKE 200]
              ↓       ↓       ↓       ↓       ↓
Bloc 100002:  C=1500  U=1500  Cr=50   Ur=50   T=10   (no KHU TX)
              ↓       ↓       ↓       ↓       ↓
...
Bloc 101440:  C=1500  U=1500  Cr=50   Ur=50   T=10   [YIELD +3]
              ↓       ↓       ↓       ↓       ↓
Bloc 101441:  C=1500  U=1500  Cr=53   Ur=53   T=10   [UNSTAKE bonus=10]
              ↓       ↓       ↓       ↓       ↓
Bloc 101442:  C=1510  U=1510  Cr=43   Ur=43   T=10   (no KHU TX)
              ↓       ↓       ↓       ↓       ↓
...
Bloc 172800:  C=1510  U=1510  Cr=43   Ur=43   T=10   [DAO BOUNDARY]
              ↓       ↓       ↓       ↓       ↓
Bloc 172801:  C=1510  U=1510  Cr=43   Ur=43   T=17   (T += 0.5% × (U+Ur))
