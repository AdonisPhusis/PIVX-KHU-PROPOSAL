 ...
 * - Aucune note stockée dans KhuGlobalState
...
/**
 * ApplyDailyYield - Apply daily yield to all mature staked notes
 *
 ...
 *
 * RÈGLE CONSENSUS:
 * - Note must be staked for at least MATURITY_BLOCKS (4320 blocks = 3 days)
 *
 * @param noteHeight Height when note was created (nStakeStartHeight)
