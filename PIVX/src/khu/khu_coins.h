...
struct CKHUUTXO {
    ...
    //! Flag: KHU staké en ZKHU? (Phase 3 - STAKE/UNSTAKE)
    //! ⚠️ Phase 2: toujours false (STAKE non implémenté)
    bool fStaked;

    //! Si staké: hauteur de début de stake (Phase 3)
    //! ⚠️ Phase 2: toujours 0 (STAKE non implémenté)
